...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\zipdown on
     Windows, /home/user/dev/zipdown on Linux) in a file named
     zipdown@michael.nutt and copy that file to
